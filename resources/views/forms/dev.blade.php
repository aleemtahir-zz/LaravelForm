            ...
            <form method="post" action="{{url('development')}}">
                ...
                <div class="c-forms-form" tabindex="0">
                                          ...
                                          <div class="c-section c-col-1 c-sml-col-1 c-span-24 c-sml-span-12">
                                              ...
                                              <div class="">
                                                  ...
                                                  <div class="c-text-singleline c-field c-col-17 c-sml-col-1 c-span-4 c-sml-span-6">
                                                      ...
                                                      <div class="c-editor"><input name="developement[volume]" type="text" id="c-25-1628" placeholder=""></div>
                                                      <div class="c-validation"></div>
                                                  </div>
                                                  <div class="c-text-singleline c-field c-col-21 c-sml-col-5 c-span-4 c-sml-span-6">
                                                      ...
                                                      <div class="c-editor"><input name="developement[plan]" type="text" id="c-26-1627" placeholder="Plan number"></div>
                                                      <div class="c-validation"></div>
                                                  </div>
                                                  <div class="c-address c-address-us c-field c-col-1 c-sml-col-1 c-span-24 c-sml-span-12">
                                                      ...
                                                      <div>
                                                          ...
                                                          <div class="c-editor" style="float: left;"><input name="developement[address1]" type="text" id="c-27-1626" placeholder="Address Line 1"></div>
                                                          <div class="c-offscreen"><label for="c-28-1626">Address Line 2</label></div>
                                                          <div class="c-editor" style="float: left;"><input name="developement[address2]" type="text" id="c-28-1626" placeholder="Address Line 2"></div>
                                                          <div class="c-offscreen"><label for="c-29-1626">City</label></div>
                                                          <div class="c-editor c-partial-line" style="float: left;"><input name="developement[city]" type="text" id="c-29-1626" placeholder="City"></div>
                                                          <div class="c-offscreen"><label for="c-30-1626">State</label></div>
                                                          <div class="c-editor c-partial-line" style="float: left;">
                                                              <div class="c-dropdown">
                                                                  <select name="developement[state]" id="c-30-1626" class="c-placeholder-text-styled ">
                                                  ...
                                                  <div class="c-name c-field c-col-1 c-sml-col-1 c-span-24 c-sml-span-12">
                                                      ...
                                                      <div>
                                                          ...
                                                          <div class="c-editor c-span-1" style="width: 20%; float: left;"><input name="developement[title]" type="text" id="c-32-1625" placeholder="Title"></div>
                                                          <div class="c-offscreen"><label for="c-33-1625">First</label></div>
                                                          <div class="c-editor c-span-1" style="width: 40%; float: left;"><input name="developement[first]" type="text" id="c-33-1625" placeholder="First"></div>
                                                          <div class="c-offscreen"><label for="c-34-1625">Last</label></div>
                                                          <div class="c-editor c-span-1" style="width: 40%; float: left;"><input name="developement[last]" type="text" id="c-34-1625" placeholder="Last"></div>
                                                      </div>
                                                      <div class="c-validation"></div>
                                                  </div>
                                                  <div class="c-section c-col-1 c-sml-col-1 c-span-24 c-sml-span-12">
                                              ...
                                              <div class="">
                                                  ...
                                                  <div class="c-name c-field c-col-1 c-sml-col-1 c-span-24 c-sml-span-12">
                                                      ...
                                                      <div>
                                                          ...
                                                          <div class="c-editor c-span-1" style="width: 20%; float: left;"><input name="contractor[title]" type="text" id="c-45-1876" placeholder="Title"></div>
                                                          <div class="c-offscreen"><label for="c-46-1876">First</label></div>
                                                          <div class="c-editor c-span-1" style="width: 40%; float: left;"><input name="contractor[first]" type="text" id="c-46-1876" placeholder="First"></div>
                                                          <div class="c-offscreen"><label for="c-47-1876">Last</label></div>
                                                          <div class="c-editor c-span-1" style="width: 40%; float: left;"><input name="contractor[last]" type="text" id="c-47-1876" placeholder="Last"></div>
                                                      </div>
                                                      <div class="c-validation"></div>
                                                  </div>
                                                  <div class="c-address c-address-international c-field c-col-1 c-sml-col-1 c-span-24 c-sml-span-12">
                                                      ...
                                                      <div>
                                                          ...
                                                          <div class="c-editor" style="float: left;"><input name="contractor[address1]" type="text" id="c-49-1637" placeholder="Address Line 1"></div>
                                                          <div class="c-offscreen"><label for="c-50-1637">Address Line 2</label></div>
                                                          <div class="c-editor" style="float: left;"><input name="contractor[address2]" type="text" id="c-50-1637" placeholder="Address Line 2"></div>
                                                          <div class="c-offscreen"><label for="c-51-1637">City</label></div>
                                                          <div class="c-editor c-partial-line" style="float: left;"><input name="contractor[city]" type="text" id="c-51-1637" placeholder="City"></div>
                                                          <div class="c-offscreen"><label for="c-52-1637">State / Province / Region</label></div>
                                                          <div class="c-editor c-partial-line" style="float: left;"><input name="contractor[state]" type="text" id="c-52-1637" placeholder="State / Province / Region"></div>
                                                          <div class="c-offscreen"><label for="c-53-1637">Country</label></div>
                                                          <div class="c-editor c-partial-line" style="float: left;">
                                                              <div class="c-dropdown">
                                                                  <select name="contractor[country]" id="c-53-1637" class="c-placeholder-text-styled">
                                                                      <option value="">Country</option>
                                                                      <option value="Afghanistan">Afghanistan</option>
                                                                      <option value="Albania">Albania</option>
                                                                      <option value="Algeria">Algeria</option>
                                  ...
                                  <div class="c-forms-template" >
                                      <div class="c-page toggle-off">
                                          <div class="c-section c-col-1 c-sml-col-1 c-span-24 c-sml-span-12">
                                              ...
                                              <div class="">
                                                  <div class="c-choice-dropdown c-field c-col-1 c-sml-col-1 c-span-12 c-sml-span-12 c-modified">
                                                      <div class="c-label  "><label for="c-55-1896">Foreign Currency</label></div>
                                                      <div class="c-editor">
                                                          <input name="payment[foreign_currency]" type="text" id="c-55-1896" placeholder="" class="c-autocomplete" autocomplete="off" height="">
                                                          <ul class="typeahead dropdown-menu" style="top: 93px; left: 8px; display: none;">
                                                              <li data-value="United States Dollar" data-index="0" class="active"><a href="#"><strong>United States Dollar</strong></a></li>
                                                          </ul>
                                                      </div>
                                                      <div class="c-validation"></div>
                                                  </div>
                                                  <div class="c-text-singleline c-field c-col-13 c-sml-col-1 c-span-6 c-sml-span-6">
                                                      ...
                                                      <div class="c-editor"><input name="payment[fc_symbol]" type="text" id="c-56-1895" placeholder=""></div>
                                                      <div class="c-validation"></div>
                                                  </div>
                                                  <div class="c-text-singleline c-field c-col-19 c-sml-col-7 c-span-6 c-sml-span-6">
                                                      ...
                                                      <div class="c-editor"><input name="payment[fc_rate]" type="text" id="c-57-1894" placeholder=""></div>
                                                      <div class="c-validation"></div>
                                                  </div>
                                                  <div class="c-currency c-field c-col-1 c-sml-col-1 c-span-6 c-sml-span-12">
                                                      <div class="c-label  "><label for="c-58-1893">Contract Price in numbers</label></div>
                                                  ...
                                                  <div class="c-currency c-field c-col-1 c-sml-col-1 c-span-6 c-sml-span-12">
                                                      <div class="c-label  "><label for="c-60-1891">Contract Price $J in numbers</label></div>
                                                  ...
                                                  <div class="c-currency c-field c-col-1 c-sml-col-1 c-span-12 c-sml-span-12">
                                                      ...
                                                      <div class="c-editor"><input name="payment[scnd_pay]" type="text" id="c-63-1888" placeholder=""></div>
                                                      <div class="c-validation"></div>
                                                  </div>
                                                  <div class="c-currency c-field c-col-1 c-sml-col-1 c-span-12 c-sml-span-12">
                                                      <div class="c-label  "><label for="c-64-1887">Contract Third Payment</label></div>
                                                      <div class="c-editor"><input name="payment[thrd_pay]" type="text" id="c-64-1887" placeholder=""></div>
                                                      <div class="c-validation"></div>
                                                  </div>
                                                  <div class="c-currency c-field c-col-1 c-sml-col-1 c-span-12 c-sml-span-12">
                                                      <div class="c-label  "><label for="c-65-1886">Contract Fourth Payment</label></div>
                                                      <div class="c-editor"><input name="payment[frth_pay]" type="text" id="c-65-1886" placeholder=""></div>
                                                      <div class="c-validation"></div>
                                                  </div>
                                                  <div class="c-currency c-field c-col-1 c-sml-col-1 c-span-12 c-sml-span-12">
                                                      <div class="c-label  "><label for="c-66-1885">Contract Final Payment</label></div>
                                                      <div class="c-editor"><input name="payment[fnl_pay]" type="text" id="c-66-1885" placeholder=""></div>
                                                      <div class="c-validation"></div>
                                                  </div>
                                              </div>
                                              <div class="c-validation"></div>
                    ...
                    <div class="c-footer-terms" >
                        <ul class="terms">
                            <li><a href="https://www.cognitoforms.com/reportabuse?form=https%3A%2F%2Fwww.cognitoforms.com%2FMarcusWilliams1%2FHMFDeveloperDataForm" target="_blank">Report Abuse</a></li>
